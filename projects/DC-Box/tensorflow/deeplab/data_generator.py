...
_LEAF_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 7051,  # num of samples in images/training
        'val': 668,  # num of samples in images/validation
    },
    num_classes=21,
    ignore_label=255,
)
...
_DATASETS_INFORMATION = {
    ...
    'leaf_voc_seg': _LEAF_INFORMATION,
}
...
class Dataset(object):
  ...
  def __init__(self,
    ...
    if split_name not in splits_to_sizes:
      raise ValueError('data split name {0} not recognized'.format(split_name))
